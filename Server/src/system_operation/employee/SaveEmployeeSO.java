...
public class SaveEmployeeSO extends AbstractSO {
    ...
    protected void precondition(Object param) throws Exception {
        Validator.startValidation()
                ...
                .validateNotNullOrEmpty(((Employee) param).getFirstName(), "First name must not be null or empty")
                .validateNotNullOrEmpty(((Employee) param).getLastName(), "Last name must not be null or empty")
